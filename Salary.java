...
public class Salary {
    ...
    public static void main(String[] args) {
        ...
        if (age < 18) {
            System.out.println("\nInvalid age!!!. Age should be more than 18 years.");

        }

        else if(age > 55){
            System.out.println("\nInvalid age!!!. Age should be less than 55 years.");
        }
            ...
            if (monthlySalary >= 4500 && monthlySalary <= 6500) {
                ...
                System.out.println("Invalid salary!!!. Monthly Salary should be between Rs.4500 and Rs.6500");
            }
        } else {
